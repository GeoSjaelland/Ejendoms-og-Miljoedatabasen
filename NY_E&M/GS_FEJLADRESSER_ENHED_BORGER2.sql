SELECT DISTINCT
				MIN(GS_BORGER.Tidsstempling_tilflytning) AS Tidligste_indflytning,
...
GROUP BY
				CONVERT(VARCHAR, GS_BORGER.Adresse),
				GS_BORGER.Supplerende_bynavn,
				GS_BORGER.Husnummer_bogstav,
				GS_BORGER.Etage,
				GS_BORGER.Side,
				CONVERT(VARCHAR, GS_BORGER.Postdistrikt),
				CONVERT(VARCHAR, GS_BORGER.ADRESSELINK_ID),
				CONVERT(VARCHAR, GS_BORGER.ADRESSE_ID),
				CONVERT(VARCHAR, GS_BORGER.UDVadresseID),
				CONVERT(VARCHAR, GS_BORGER.Husnummer_bogstav)