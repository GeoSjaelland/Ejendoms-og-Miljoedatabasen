SELECT
				...
				JY72400V.NOTATNR AS Notatnummer,
				JY72400V.NOTATTEKST AS Notattekst,
				JY72400V.OPRET_TS AS Notattidspunkt,
				JY72400V.AENDR_TS AS Notat_ændret,
				JY72400V.OPHOERT_TS AS Notat_ophørt
FROM
				JY70100V LEFT OUTER JOIN
        JY72400V ON JY70100V.BYG_ID = JY72400V.FK_PARENT_ID LEFT OUTER JOIN
...
WHERE
				(NOT (dbo.JY72400V.NOTATTEKST IS NULL))