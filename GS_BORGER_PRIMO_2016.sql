SELECT
				...
				CASE
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 0  AND 5  Then '0 - 5 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 6  AND 16 Then '06 - 16 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 17 AND 24 Then '17 - 24 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 25 AND 44 Then '25 - 44 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 45 AND 59 Then '45 - 59 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 60 AND 64 Then '60 - 64 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 65 AND 66 Then '65 - 66 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 67 AND 74 Then '67 - 74 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 75 AND 79 Then '75 - 79 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 80 AND 84 Then '80 - 84 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) BETWEEN 85 AND 89 Then '85 - 89 år'
					WHEN CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) > 89 							Then 'Over 89 år'
				END AS Aldersklasse,
				CONVERT(INT, DATEDIFF(d, Borger.FØDSEL_DATO, '20160107') / 365.25) AS Alder,
...
WHERE
				CONVERT(datetime, LEFT(Bosaettelse.ADR_TILFLYT_TS, 10))  <=  '20160107' and CONVERT(datetime, LEFT(Bosaettelse.ADR_FRAFLYT_TS, 10)) > '20160107'