SELECT
				...
				CAST(AA70000V.FODSEL_DATO AS datetime) AS Fødselsdato,
				...
				CAST(AA70000V.STATSB_RET_TS AS datetime) AS Statsborgerret_ændring,
				CAST(AA70000V.STATBORG_OPHOR_TS AS datetime) AS Statsborgerret_Ophør,
