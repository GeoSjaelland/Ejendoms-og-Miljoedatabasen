SELECT
				...
				CAST(AA70000V.FODSEL_DATO AS date) AS Fødselsdato,
				...
				CAST(AA70100V.ADR_TILFLYT_TS AS date) AS Tilflytningsdato,
				CAST(AA70100V.ADR_FRAFLYT_TS AS date) AS Fraflytningsdato,
				CAST(AA70100V.KOM_TILFLYTDATO AS date) AS Kommunetilflytningsdato,
				CAST(AA70100V.KOM_FRAFLYTDATO AS date) AS Kommunefraflytningsdato,
				...
				CAST(AA70000V.STATSB_RET_TS AS date) AS Statsborgerret_ændring,
				CAST(AA70000V.STATBORG_OPHOR_TS AS date) AS Statsborgerret_Ophør,
