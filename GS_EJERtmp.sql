SELECT
				...
				JY67700V_T.VEJ_KODE AS Vejkode,
				JY67700V_T.HUS_NUMMER AS Husnummer_bogstav,
				...
				CASE
				 WHEN CONVERT(VARCHAR, JY67700V_T.KOMMUNENUMMER) <> ''
				 THEN CONVERT(VARCHAR, JY67700V_T.KOMMUNENUMMER) + RIGHT('0000' + CONVERT(VARCHAR, JY67700V_T.VEJ_KODE), 4) + RTRIM(JY67700V_T.HUS_NUMMER)
				...
				CASE
				 WHEN CONVERT(VARCHAR, JY67700V_T.KOMMUNENUMMER) <> ''
				 THEN CONVERT(VARCHAR, JY67700V_T.KOMMUNENUMMER) + CONVERT(VARCHAR, JY67700V_T.VEJ_KODE) + CONVERT(VARCHAR, JY67700V_T.HUS_NUMMER)
				 ELSE CONVERT(VARCHAR, JY67500V_T.EKOMNR) + CONVERT(VARCHAR, JY67500V_T.VEJ_KODE) + RTRIM(JY67500V_T.HUS_NUMMER)
				END AS ADRESSE_ID,
				CASE
				 WHEN CONVERT(VARCHAR, JY67700V_T.KOMMUNENUMMER) <> ''
				 THEN CONVERT(VARCHAR, CONVERT(VARCHAR, JY67700V_T.KOMMUNENUMMER) + CONVERT(VARCHAR, JY67700V_T.VEJ_KODE) + CONVERT(VARCHAR, JY67700V_T.HUS_NUMMER) + LTRIM(RTRIM(REPLACE(JY67700V_T.ETAGE, ' ', ''))) + LTRIM(RTRIM(REPLACE(JY67700V_T.SIDE_DOERNR, ' ', ''))))
				 ELSE CONVERT(VARCHAR, JY67500V_T.EKOMNR) + CONVERT(VARCHAR, JY67500V_T.VEJ_KODE) + RTRIM(JY67500V_T.HUS_NUMMER)
				END AS UDVADRESSEID,
				CASE
				...
				END AS MatrikelID
FROM
				QL50000V_T RIGHT OUTER JOIN
				QL63500V_T RIGHT OUTER JOIN
				...
				CO11800T ON
				JY67300V_T.EEJDNR = CO11800T.EJD_NR AND
				JY67300V_T.CELAV = CO11800T.EJERLAV_KODE AND
				JY67300V_T.EMATNR = CO11800T.MATR_NR AND
				JY67300V_T.ABGSTM = CO11800T.MATR_BOGSTAV LEFT OUTER JOIN
				JY63500V_T ON
				JY67300V_T.CLELAV = JY63500V_T.CELAVLA LEFT OUTER JOIN
				JY67700V_T ON
				JY67300V_T.EEJDNR = JY67700V_T.EJENDOMSNR AND
				JY67300V_T.ABGSTM = JY67700V_T.MATRIKELBOGSTAV AND
				JY67300V_T.EMATNR = JY67700V_T.MATRIKELNR AND
				JY67300V_T.CLELAV = JY67700V_T.LANDSEJERLAVSKODE LEFT OUTER JOIN
				JY67500V_T ON
				JY67300V_T.EEJDNR = JY67500V_T.EEJDNR ON
				QL65000V_T.KODE = JY67500V_T.CADM RIGHT OUTER JOIN
				QL61000V_T ON
				JY67500V_T.CARTK = QL61000V_T.KODE ON
				QL61500V_T.KODE = JY67500V_T.CBENYT RIGHT OUTER JOIN
				JY64900V_T ON
				JY67300V_T.EEJDNR = JY64900V_T.EEJDNR LEFT OUTER JOIN
				QL63700V_T ON
				JY64900V_T.COVMD = QL63700V_T.KODE ON
				QL63400V_T.KODE = JY64900V_T.CPENS ON
				QL63200V_T.KODE = JY64900V_T.CMSTAT ON
				QL63500V_T.KODE = JY64900V_T.CLEJE ON
				QL50000V_T.KODE = JY64900V_T.CEJFORH LEFT OUTER JOIN
				QL63600V_T ON
				JY64900V_T.CBSKADR = QL63600V_T.KODE
WHERE        (
				JY67300V_T.CARTK <> 2 AND
				JY67300V_T.CARTK <> 3)